...
const Facts = () => {
  ...
  return (
    <div className="flex flex-col lg:px-[5%] px-0 bg-offWhite">
      ...
      <div
        className="flex-col flex lg:flex-row gap-5 lg:gap-20 py-20 px-[5%] items-center"
        id="facts-about-us"
      >
        {facts.map((fact, i) => {
          return (
            <div
              key={i}
              className="flex flex-col justify-center lg:justify-start items-start lg:w-[30%] w-full h-[320px] shadow-custom rounded-[12px] px-6 py-10"
            >
